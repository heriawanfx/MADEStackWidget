...
public class ImagesBannerWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.heriawanfx.madestackwidget.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.heriawanfx.madestackwidget.EXTRA_ITEM";
